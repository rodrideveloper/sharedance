import 'package:flutter/mateclass ShareDanceWithInvitationsApp extends StatelessWidget {
        ...
        return FutureBuilder<String?>(
          ...
          builder: (context, tokenSnapshot) {
            ...
            return MultiBlocProvider(
              ...
              child: MaterialApp( 'package:flutter_bloc/flutter_bloc.dart';
        ...
        BlocProvider(
          create:
              (context) => InvitationsBloc(
                invitationService: InvitationService(
                  baseUrl: 'https://sharedance.com.ar',
                  authToken: null, // TODO: Obtener token de autenticación
                ),
              ),
        ),
      ],
